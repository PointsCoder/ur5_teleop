...
class Args:
    ...
    # hostname: str = "192.10.0.10" # from local PC ip
...
def launch_robot_server(args: Args):
    ...
    if args.robot == "sim_ur":
        ...
        if args.robot == "xarm":
            ...
            # from urx_local.robot import URRobot

            robot = URRobot(robot_ip=args.robot_ip)
            # robot = urx_local.Robot("192.10.0.11")
        elif args.robot == "urx":
            from gello.robots.urx_robot import URXRobot
            robot = URXRobot(robot_ip=args.robot_ip)

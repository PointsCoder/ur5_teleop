...
class URRobot(Robot):
    ...
    def __init__(self, robot_ip: str = "192.10.0.11", no_gripper: bool = True):
        import rtde_control
        import rtde_receive
        ...
        try:
            ...
            # self.robot = urx.Robot("192.10.0.11")
            # print('done')
        ...
        # self.r_inter = urx.Robot("192.10.0.11")
        if not no_gripper:

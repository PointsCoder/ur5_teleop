...
PORT_CONFIG_MAP: Dict[str, DynamixelRobotConfig] = {
    ...
    "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FT94EJX0-if00-port0": DynamixelRobotConfig(
        joint_ids=(1, 2, 3, 4, 5, 6, 7),
        joint_offsets=(
            3 * np.pi / 2,
            2 * np.pi / 2,
    ...
    # Left UR
    "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FT94EJQJ-if00-port0": DynamixelRobotConfig(
    ...
    # Right UR
    # "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FT94EJX0-if00-port0"
    "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FT94EJQJ-if00-port0": DynamixelRobotConfig(
        joint_ids=(1, 2, 3, 4, 5, 6),
        # joint_offsets=(
        #     np.pi + 0 * np.pi,
